        ...
        make_marquee_class=function(duration){
            ...
            if(!marquee_classes[marquee_class]){//还没有对应的样式名
                ...
                setTimeout(function(){//延迟.5生成样式
                    styleSheet('@'+webkit+'keyframes '+marquee_class+'{0%{'+webkit+'transform:translate3d(0,0,0);}100%{'+webkit+'transform:translate3d(-100%,0,0);}}');
                    styleSheet('.'+marquee_class+'_move{'+webkit+'animation: '+marquee_class+' '+duration+'s linear infinite;}');
                },500);
            }
